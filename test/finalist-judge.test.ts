...
describe("finalist judge", () => {
  ...
  it("passes planned judging preset fields to the judge for consultation-plan tasks", async () => {
    ...
    let capturedPlannedJudgingPreset:
      | Parameters<AgentAdapter["recommendWinner"]>[0]["plannedJudgingPreset"]
      | undefined;
    ...
    const outcome = await recommendWinnerWithJudge({
      ...
      consultationPlan: {
        ...
        recommendedNextAction:
          "orc consult .oraculum/runs/run_plan_judging_preset/reports/consultation-plan.json",
  ...
  it("passes finalist scorecards to the judge and persists the finalist scorecard bundle", async () => {
    ...
    let capturedFinalists: Parameters<AgentAdapter["recommendWinner"]>[0]["finalists"] | undefined;
    ...
    const outcome = await recommendWinnerWithJudge({
      ...
      consultationPlan: {
        ...
        readyForConsult: true,
        recommendedNextAction:
          "orc consult .oraculum/runs/run_plan_scorecards/reports/consultation-plan.json",
        intendedResult: "recommended result for docs/PRD.md",
        decisionDrivers: ["Target artifact path: docs/PRD.md"],
        plannedJudgingCriteria: [],
        crownGates: [],
