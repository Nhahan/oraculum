...
- [x] Add non-Node/generalized README claims or examples only after the generalized behavior is actually implemented and verified.
...
- [x] Keep examples simple, but include at least one non-Node example once tested.
