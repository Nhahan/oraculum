...
export function buildConsultationArtifactPathCandidates(
  ...
  return {
    ...
    planningDepthPath: runPaths.planningDepthPath,
    planningInterviewPath: runPaths.planningInterviewPath,
    planningSpecPath: runPaths.planningSpecPath,
    planningSpecMarkdownPath: runPaths.planningSpecMarkdownPath,
    planConsensusPath: runPaths.planConsensusPath,
