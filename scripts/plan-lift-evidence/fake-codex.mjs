export function buildFakeCodexSource(planLiftHarness) {
  ...
  return [
    ...
    "  respond({ interviewDepth: 'skip-interview', readiness: 'ready', confidence: 'high', summary: 'The plan-lift fixture task is explicit enough to plan.', reasons: ['Fixture task packet is pre-authored.'], estimatedInterviewRounds: 0, consensusReviewIntensity: 'standard' });",
    "  process.exit(0);",
    "}",
    ...
    "  process.exit(0);",
    "}",
    "if (prompt.includes('asking the next Augury Interview question')) {",
    "  respond({ question: 'What concrete result should this fixture preserve?', perspective: 'fixture-contract', expectedAnswerShape: 'Name the fixture result and the evidence future candidates must satisfy.' });",
    "  process.exit(0);",
    "}",
    "if (prompt.includes('scoring whether the latest Augury Interview answer')) {",
    ...
    "  process.exit(0);",
    "}",
    "if (prompt.includes('crystallizing an explicit Oraculum Augury Interview')) {",
    ...
    "  process.exit(0);",
    "}",
    "if (prompt.includes('drafting a Plan Conclave-reviewed Oraculum consultation plan')) {",
    ...
    "  process.exit(0);",
    "}",
    "if (prompt.includes('revising a Plan Conclave consultation plan draft')) {",
